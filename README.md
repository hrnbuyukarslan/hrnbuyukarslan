...
My work spans from **bare-metal microcontrollers** to **SDR-based ground stations**, combining
low-level engineering discipline with system-level thinking.
...
**electronics · RF · software · space systems**
...
---
## 📂 Featured Repositories (Coming / In Progress)
